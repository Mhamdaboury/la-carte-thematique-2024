...
map.getView().fit([-1174093.878167, 3699109.855424, -809434.438339, 4070069.013662], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">La carte de recenement 2024 de la population pour la région Marrakech_Safi (by ABOURY)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (189 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte choropléthe interactive basée sur la variation de la population entre les différentes provinces de la région de<br />Marrakech Safi selon le recensement du septembre 2024';
            }
